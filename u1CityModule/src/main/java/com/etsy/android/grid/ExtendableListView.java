...
//            case TOUCH_MODE_OVERSCROLL:
    ...
    private boolean moveTheChildren(int deltaY, int incrementalDeltaY) {
        ...
        if(realScrollY >= 0 && realScrollY - incrementalDeltaY >= 0 && oldFirstTop != firstTop){
            realScrollY -= incrementalDeltaY;
            
            if(realScrollListener != null){
                realScrollListener.onRealScroll(realScrollY);
            }
            Debug.d(TAG, "realScrollY:" + realScrollY);
        }
