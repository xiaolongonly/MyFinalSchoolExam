...
//    private float oldRealY = 0;
//    private int realScrollY = 0;
//    private RealScrollListener realScrollListener;
//    
//    /** 添加的方法，解决getScrollY总是为0的问题 */
//    public interface RealScrollListener{
//        public void onRealScroll(int realScrollY);
//    }
//    public void setRealScrollListener(RealScrollListener realScrollListener){
//        this.realScrollListener = realScrollListener;
//    }
...
//    private boolean isStarted = false;
    ...
    {
//        Debug.d(TAG, "y:" + " -- height:" + getHeight());
        
        final int myAction = event.getAction() & MotionEventCompat.ACTION_MASK;
        switch (myAction) {
            case MotionEvent.ACTION_DOWN:
//                oldRealY =  event.getY();
//                isStarted = true;
//                Debug.d(TAG, "down oldRealY:" + oldRealY);
                break;
...
//                    break;
//                }
//                float increase = event.getY() - oldRealY;
//
//                oldRealY = event.getY();
//                
//                realScrollY -= increase;
//
//                realScrollListener.onRealScroll((int) realScrollY);
//                Debug.d(TAG, "move increase:" + increase);
//                Debug.d(TAG, "scroll:" + getScrollY());
                break;

            case MotionEvent.ACTION_CANCEL:
//                oldRealY = event.getY();
//                isStarted = false;
//                Debug.d(TAG, "CANCEL oldRealY:" + oldRealY); 
                break;

            case MotionEvent.ACTION_POINTER_UP:
//                oldRealY = event.getY();
//                isStarted = false;
//                Debug.d(TAG, "POINTER_UP oldRealY:" + oldRealY); 
                break;

            case MotionEvent.ACTION_UP:
//                oldRealY = event.getY();
//                isStarted = false;
//                Debug.d(TAG, "UP oldRealY:" + oldRealY); 
                break;
