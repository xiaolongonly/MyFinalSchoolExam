...
//  private View resultView;
  ...
  public boolean isEnableRework()
{
    return enableRework;
}

  /** 设置是否可以重复扫描 */
public void setEnableRework(boolean enableRework)
{
...
//    resultView = findViewById(R.id.result_view);
    ...
    if (intent != null) {
      ...
      String twoCode = PreferencesUtils.getStringValue(CaptureActivity.this, "TwoCode");
      if(twoCode.equals("TwoCode"))
      {
          statusView.setText("请将二维码置于框内，即可自动扫描");
      }
      else 
      {
          statusView.setText("请将条码置于框内，即可自动扫描");
      }
  ...
  public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
    ...
    if (fromLiveScan) {
     // historyManager.addHistoryItem(rawResult, resultHandler);
      ...
      //data.putString("code", rawResult.getText());
      if (enableRework)
      {
          getCaptureData(rawResult.getText());
          try
          {
              Thread.sleep(1500);
          }
      ...
      {
          Intent d = new Intent();
          d.putExtra("code", rawResult.getText());
...
//        }
  ...
  /** 获取扫描到的数据 */
  public void getCaptureData(String captureData){
  }
