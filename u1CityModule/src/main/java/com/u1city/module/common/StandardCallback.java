/*
 * 系统: U1CityModule
 * 文件名: StandardCallback.java
 * 版权: U1CITY Corporation 2015
 * 描述:
 * 创建人: zhengjb
 * 创建时间: 2015-8-27 上午9:58:44
 */
...
public abstract class StandardCallback extends HttpCallBack
{
     ...
     * */
    public StandardCallback(Activity context)
    {
        super(context);
    }
     ...
     * @param enableMsgToast 是否使用服务端返回错误信息
     * */
    public StandardCallback(Activity context, boolean enableMsgToast)
    {
        super(context);
        this.enableMsgToast = enableMsgToast;
    }
     ...
     * @param enableToastError 是否使用错误提示
     * */
    public StandardCallback(Activity context, boolean enableMsgToast, boolean enableToastError)
    {
        super(context);
        this.enableMsgToast = enableMsgToast;
        this.enableToastError = enableToastError;
     ...
     * @param enableMsgToast 是否使用服务端返回错误信息
     * */
    public StandardCallback(Fragment fragment, boolean enableMsgToast)
    {
        super(fragment);
        this.enableMsgToast = enableMsgToast;
    }
     ...
     * @param enableToastError 是否使用错误提示
     * */
    public StandardCallback(Fragment fragment, boolean enableMsgToast, boolean enableToastError)
    {
        super(fragment);
        this.enableMsgToast = enableMsgToast;
        this.enableToastError = enableToastError;
    ...
    public final void onSuccess(JSONObject response)
    {
        ...
        BaseAnalysis analysis = new BaseAnalysis(response);
        if (analysis.success())
        {
            try
            {
     ...
     * */
    public abstract void onResult(BaseAnalysis analysis) throws Exception;
