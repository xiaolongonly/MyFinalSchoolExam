...
public class PullToRefreshPinnedHeaderListView extends PullToRefreshAdapterViewBase<PinnedHeaderListView> {
	...
	protected PinnedHeaderListView createRefreshableView(Context context, AttributeSet attrs) {
	    PinnedHeaderListView lv = (PinnedHeaderListView)createListView(context, attrs);
		...
		public InternalListView(Context context, AttributeSet attrs) {
		 ...
		 public int getScrollY1() {
		      ...
		      //Debug.e("---------------ev-----------------"+ev.getY());
                ...
                mScrollListener.onScroll(scrollY, firstVisiblePosition, -top);
		        }
		        return  scrollY;
		    }
	...
	public interface OnScrollListener{
		 ...
		 * 				、
		 */
		public void onScroll(int scrollY,int firstPosition,int itemTop);
	}
