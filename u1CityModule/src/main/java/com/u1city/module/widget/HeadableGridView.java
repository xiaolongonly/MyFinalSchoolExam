 ...
 * See {@link HeadableGridView#addHeaderView(View, Object, boolean)}
 * See {@link HeadableGridView#addFooterView(View, Object, boolean)}
 * 
 * 实现了gridview对header和footer的添加
 * 
 */
public class HeadableGridView extends GridView {
    ...
    public HeadableGridView(Context context) {
        super(context);
        initHeaderGridView();
    }

    public HeadableGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderGridView();
    }

    public HeadableGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class FullWidthFixedViewLayout extends FrameLayout {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            int realLeft = HeadableGridView.this.getPaddingLeft() + getPaddingLeft();
        ...
        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int targetWidth = HeadableGridView.this.getMeasuredWidth()
                    - HeadableGridView.this.getPaddingLeft()
                    - HeadableGridView.this.getPaddingRight();
